...
with open('e:/project/PORTFOLIO/index.html', 'r', encoding='utf-8') as f:
    content = f.read()

new_timeline = """     <!-- Timeline Item 1: Education -->
     <div class="relative flex flex-col md:flex-row items-center md:justify-between mb-xl">
      <!-- Timeline Dot -->
      <div class="absolute left-[-5px] md:left-1/2 md:-ml-2 w-4 h-4 rounded-full bg-surface-dim border-2 border-secondary z-10">
      </div>
      ...
      <div class="w-full md:w-5/12 pl-lg md:pl-0 md:pr-lg md:text-right">
       <div class="bg-surface-container-low border border-surface-variant p-md rounded-lg hover:border-secondary transition-colors duration-200">
        ...
        <p class="font-label-sm text-label-sm text-secondary mb-sm">
         Academic Institution • 2024 - Present
        </p>
        ...
        <div class="flex flex-wrap gap-xs md:justify-end">
         <span class="bg-surface-container-highest px-2 py-1 rounded text-label-sm font-label-sm text-on-surface">
          Computer Science
         </span>
         <span class="bg-surface-container-highest px-2 py-1 rounded text-label-sm font-label-sm text-on-surface">
          Architecture
     ...
     <div class="relative flex flex-col md:flex-row items-center md:justify-between mb-xl">
      <!-- Timeline Dot -->
      <div class="absolute left-[-5px] md:left-1/2 md:-ml-2 w-4 h-4 rounded-full bg-surface-dim border-2 border-primary z-10">
      </div>
      ...
      <div class="w-full md:w-5/12 pl-lg md:pl-lg">
       <div class="bg-surface-container-low border border-surface-variant p-md rounded-lg hover:border-primary transition-colors duration-200">
        ...
        <p class="font-label-sm text-label-sm text-primary mb-sm">
         Forage • 2024
        </p>
        <p class="font-body-md text-body-md text-on-surface-variant mb-md">
     ...
     <div class="relative flex flex-col md:flex-row items-center md:justify-between mb-xl">
      <!-- Timeline Dot -->
      <div class="absolute left-[-5px] md:left-1/2 md:-ml-2 w-4 h-4 rounded-full bg-surface-dim border-2 border-tertiary-container z-10">
      </div>
      <!-- Content (Left Side Desktop, Right Side Mobile) -->
      <div class="w-full md:w-5/12 pl-lg md:pl-0 md:pr-lg md:text-right">
       <div class="bg-surface-container-low border border-surface-variant p-md rounded-lg hover:border-tertiary-container transition-colors duration-200">
        <div class="flex items-center md:justify-end gap-xs mb-xs">
         <span class="material-symbols-outlined text-tertiary-container text-xl">
          groups
         </span>
         <h3 class="font-h3 text-h3 text-on-surface">
        ...
        <p class="font-label-sm text-label-sm text-tertiary-container mb-sm">
     ...
     <div class="relative flex flex-col md:flex-row items-center md:justify-between mb-xl">
      ...
      <div class="w-full md:w-5/12 pl-lg md:pl-0 md:pr-lg md:text-right">
       <div class="bg-surface-container-low border border-surface-variant p-md rounded-lg hover:border-primary transition-colors duration-200">
        ...
        <p class="font-label-sm text-label-sm text-primary mb-sm">
         Future Interns • April 2026 - Present
        </p>
        <p class="font-body-md text-body-md text-on-surface-variant mb-md">
...
pattern = re.compile(r'(     <!-- Timeline Item 1: Intern -->)(.*?)(     </div>\n    </div>\n   </section>\n   <section class="py-xl reveal" id="labs">)', re.DOTALL)

if pattern.search(content):
    new_content = pattern.sub(new_timeline + r'\n\3', content)
    with open('e:/project/PORTFOLIO/index.html', 'w', encoding='utf-8') as f:
        f.write(new_content)
